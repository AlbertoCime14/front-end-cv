                    ...
                    <div className="cover bg-image"><img src="/../../resources/images/header-background.jpg" />
                        <div className="mask" style={{backgroundColor:'rgba(0, 0, 0, 0.7)', backdropfilter: 'blur(2px)'}}>
                            <div className="text-center p-5">
                                <div className="avatar p-1"><img className="img-thumbnail shadow-2-strong" src="/../../resources/images/profile_albertoCime.jpeg" width="160"
                                    height="160" />
                                </div>
                                <div className="header-bio mt-3">
                                    ...
                                    <div className="header-social mb-3 d-print-none" data-aos-delay="200">
                                        <nav role="navigation">
                                            <ul className="nav justify-content-center">
                                                <li className="nav-item"><a className="nav-link" href="https://www.linkedin.com/in/alberto-orlando-cime-castellanos-4405b6225/"
                                    ...
                                    <div className="d-print-none"><a className="btn btn-outline-light btn-lg shadow-sm mt-1 me-3"
                                        href="material-resume.pdf" data-aos-delay="700">Download CV</a>
                                    </div>
                                </div>
                            </div>
                        </div>
